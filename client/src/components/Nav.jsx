...
export default function Nav() {
    ...
    return (
        <div id="site-nav">
            {/* <nav className="bg-gray-600 px-2 sm:px-4 py-1.5 dark:bg-gray-900">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className={"lg:flex flex-grow items-center" +
                        ...
                        <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
